...
class Gentor(object):
    """docstring for Gentor."""

    def __init__(self, functions):
        super(Gentor, self).__init__()
...
class FucntionGentor(object):
    """docstring for FucntionGentor."""

    def __init__(self, function):
        super(FucntionGentor, self).__init__()
        self.function = function
        self.symbol = function.symbol
        self.cur_block = None
        self.blocks = None
